...
<div class="banner">
	<img src="../../static/img/app.jpg" alt="" class="banner__img">
	<div class="contenedor">
		<h2 class="banner__titulo">Creacion y desarrollo de aplicaciones web</h2>
		<p class="banner__txt">Dino-Web surge de la necesidad de crear aplicaciones que faciliten las tareas de los usuarios en el ámbito laboral, social y cultural.</p>
	</div>
</div>
<main class="main">
<div class="contenedor">
...
Aplicación: Ofrecer variadas opciones dentro de la aplicación de calidad que se anticipe y satisfaga los deseos y necesidades de los consumidores.
</p>
		</article>
		<article class="info__columna">
...
Responsabilidad:cumplir con la entrega de proyectos en las fechas establecidas 

Honestidad:establecer los precios adecuados para el desarrollo de aplicaciones

Compromiso: otorgar la confianza de que no fallaremos

Cooperación: potenciar el talento colectivo del equipo de trabajo
